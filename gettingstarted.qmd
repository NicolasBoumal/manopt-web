...
Go to `/my/directory/manopt/checkinstall/` and run the script `basicexample.m`. If there are no errors, you are done! Otherwise, feel free to [report issues on the forum](forum.qmd).
