...
| Isometric transport | `M.isotransp(x, y, u)` | An isometric transporter. May be the same as `M.transp`. This is not necessarily parallel transport. |
