...
* Rotation group
  * $\{R \in \mathbb{R}^{n \times n} : R^\top R = I_n, \det(R) = 1\}^k$ <br>
    ...
    See the [dedicated documentation below](#rotation-matrices-rotationsfactory).
...
However, for factories such as `rotationsfactory`, the distinction matters: [see below](#rotation-matrices-rotationsfactory).
