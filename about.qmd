...
This work is supported during 2022--2027 by the Swiss State Secretariat for Education, Research and Innovation ([SERI](https://www.sbfi.admin.ch/sbfi/en/home/research-and-innovation/international-cooperation-r-and-i/eu-framework-programmes-for-research/horizon-europe/transitional-measures.html)) under contract number MB22.00027.
...
*   [RIMOpt](https://github.com/Yuan-Jinghui/Riemannian-Optimization-on-Relaxed-Indicator-Matrix-Manifold) is a Manopt-compatible package for optimization on the relaxed indicator matrix manifold for clustering.
