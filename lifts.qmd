...
Here is a naive example aiming to compute a [column-stochastic square root](https://www.sciencedirect.com/science/article/pii/S0024379510001849) of a column stochastic matrix:
```matlab
lift = hadamardlift('colstochastic', n, m);
