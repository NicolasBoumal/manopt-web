...
To apply a regularizer, use a `lift` structure with the required fields to compute $\rho$ and (ideally) its gradient and Hessian (see @tbl-liftfields-regularizer), and call `manoptlift` with a positive `lambda`.
