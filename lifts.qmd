...
This eases the process of working with constraints, nonsmooth sets or simply a change of variables.
This is done with the tool `manoptlift`.
...
To use them, you will need a sufficiently recent version of the code (e.g., from [github](https://github.com/NicolasBoumal/manopt/).)
