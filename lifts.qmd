...
Built-in examples are listed in @tbl-lift-regularizers.
...
For example, $\varphi \colon \Rn \times \Rn \to \Rn$ defined by $\varphi(u, v) = u \odot u - v \odot v$ is a lift of $\calX = \Rn$, known as the *Hadamard difference parameterization*.
...
See this [2023 paper](https://arxiv.org/abs/2307.03571) for a discussion of this lift and associated regularizer together with bibliographic references, and a broad extension to group-lasso regularizers and more.
...
the aim is to minimize $f_\lambda(x) = \frac{1}{2}\|Ax - b\|^2 + \lambda\|x\|_1$.
